            ...
            <form className="" onSubmit={handleSubmit}>
                <div className="card-layout py-4">
                    <div className="d-flex justify-content-between">
                        ...
                        <button className="btn btn-sm pg-button btn-primary px-4" onClick={() => getBack()}>Back</button>
                    </div>
                    <p className="mb-3 text-dark">Edit the details below</p>
                    {msg ? <div className="alert alert-danger" role="alert"><p>{msg}</p></div> : null}
                    <div className="row">
                        ...
                        <div className="col-12 col-sm-4">
                            <div className="form-label-group">
                                <input
                                    ...
                                    onChange={handleChange}
                                />
                                <label htmlFor="ProspectiveStudent Id">ProspectiveStudent Id</label>
                            </div>
                        </div>
                        <div className="col-12 col-sm-4">
                            <div className="form-label-group">
                        ...
                        <div className="col-12 col-sm-4">
                            <div className="form-label-group">
                                <input
                                    ...
                                    onChange={handleChange}
                                />
                                <label htmlFor="Local Government Name">Local Government Name</label>
                            </div>
                        </div>
                    </div>
                    <button className="btn btn-lg btn-primary btn-block rounded-pill mt-2" type="submit">Save</button>
                </div>
            </form>
        </div>
    )
